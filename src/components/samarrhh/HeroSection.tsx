    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black leading-[0.9] tracking-tighter mb-8"
        >
        ...
        >
          <a
            href="#cta"
            className="btn-shockwave group relative px-8 py-4 rounded-full bg-gradient-to-r from-cyber-blue to-cyber-blue/80 text-white font-bold tracking-wide text-sm sm:text-base transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(0,210,255,0.3)]"
          >
